      ...
      <main className="pt-24 pb-12 px-4">
        <div className="max-w-2xl mx-auto animate-in fade-in slide-in-from-top-4 duration-500">
          ...
          <div className="bg-card border border-border rounded-lg p-8 mb-8">
            <p className="text-foreground/80 mb-6 text-center text-lg">
              Attendance is watched and tracked by advanced alien technology.
            </p>
          ...
          <div className="text-center text-foreground/50 text-sm flex items-center justify-center gap-2">
